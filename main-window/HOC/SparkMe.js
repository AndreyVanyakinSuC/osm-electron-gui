(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root['ReactSparklines'] = factory(root['React']);
  ...
  return /******/ (function(modules) {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var _SparklinesCurveDown2 = _interopRequireDefault(
          _SparklinesCurveDown
        );
        ...
        var _SparklinesReferenceLine2 = _interopRequireDefault(
          _SparklinesReferenceLine
        );

        var _SparklinesNormalBand = __webpack_require__(28);

        var _SparklinesNormalBand2 = _interopRequireDefault(
          _SparklinesNormalBand
        );
        ...
        var Sparklines = (function(_PureComponent) {
          ...
          function Sparklines(props) {
            ...
            return _possibleConstructorReturn(
              this,
              (Sparklines.__proto__ || Object.getPrototypeOf(Sparklines)).call(
                this,
                props
              )
            );
          ...
          _createClass(Sparklines, [
            {
              ...
              value: function render() {
                ...
                var up = (0, _dataToPoints2.default)(
                  'up',
                  data,
                  upLimit,
                  downLimit,
                ...
                var down = (0, _dataToPoints2.default)(
                  'down',
                  data,
                  upLimit,
                  downLimit,
        ...
        var SparklinesArea = (function(_React$Component) {
          ...
          function SparklinesArea() {
            ...
            return _possibleConstructorReturn(
              this,
              (
                SparklinesArea.__proto__ ||
                Object.getPrototypeOf(SparklinesArea)
          ...
          _createClass(SparklinesArea, [
            {
              ...
              value: function render() {
                var _props = this.props,
                  ...
                  divisor =
                    _props$divisor === undefined ? 0.25 : _props$divisor;

                var curve = function curve(p) {
                  return [p.x, p.y];
                };

                var upCurve = this.props.up
                  .map(function(p) {
                    return curve(p);
                  })
                  .reduce(function(a, b) {
        ...
        var SparklinesText = (function(_React$Component) {
          ...
          function SparklinesText() {
            ...
            return _possibleConstructorReturn(
              this,
              (
                SparklinesText.__proto__ ||
                Object.getPrototypeOf(SparklinesText)
              ).apply(this, arguments)
            );
          }
        ...
        var SparklinesLine = (function(_React$Component) {
          ...
          function SparklinesLine() {
            ...
            return _possibleConstructorReturn(
              this,
              (
                SparklinesLine.__proto__ ||
                Object.getPrototypeOf(SparklinesLine)
              ).apply(this, arguments)
            );
          }
        ...
        var SparklinesCurve = (function(_React$Component) {
          ...
          function SparklinesCurve() {
            ...
            return _possibleConstructorReturn(
              this,
              (
                SparklinesCurve.__proto__ ||
                Object.getPrototypeOf(SparklinesCurve)
              ).apply(this, arguments)
            );
          }
        ...
        var SparklinesCurveUp = (function(_React$Component) {
          ...
          function SparklinesCurveUp() {
            ...
            return _possibleConstructorReturn(
              this,
              (
                SparklinesCurveUp.__proto__ ||
                Object.getPrototypeOf(SparklinesCurveUp)
              ).apply(this, arguments)
            );
          }
          ...
          _createClass(SparklinesCurveUp, [
            {
              ...
              value: function render() {
                ...
                var closePolyPoints = [
                  'L' + this.props.up[this.props.up.length - 1].x,
                  height - margin,
                  margin,
                  height - margin,
                  margin,
        ...
        var SparklinesCurveDown = (function(_React$Component) {
          ...
          function SparklinesCurveDown() {
            ...
            return _possibleConstructorReturn(
              this,
              (
                SparklinesCurveDown.__proto__ ||
                Object.getPrototypeOf(SparklinesCurveDown)
              ).apply(this, arguments)
            );
          }
          ...
          _createClass(SparklinesCurveDown, [
            {
              ...
              value: function render() {
                ...
                var linePoints = this.props.down
                  .map(function(p) {
                    return curve(p);
                  })
                  .reduce(function(a, b) {
                ...
                var closePolyPoints = [
                  'L' + this.props.down[this.props.down.length - 1].x,
                  height - margin,
                  margin,
                  height - margin,
                  margin,
        ...
        var SparklinesBars = (function(_React$Component) {
          ...
          function SparklinesBars() {
            ...
            return _possibleConstructorReturn(
              this,
              (
                SparklinesBars.__proto__ ||
                Object.getPrototypeOf(SparklinesBars)
              ).apply(this, arguments)
            );
          }
              ...
              value: function render() {
                ...
                var width =
                  ...
                  (points && points.length >= 2
                    ? Math.max(
                        0,
                        points[1].x - points[0].x - strokeWidth - marginWidth
                      )
                    : 0);
        ...
        var SparklinesSpots = (function(_React$Component) {
          ...
          function SparklinesSpots() {
            ...
            return _possibleConstructorReturn(
              this,
              (
                SparklinesSpots.__proto__ ||
                Object.getPrototypeOf(SparklinesSpots)
              ).apply(this, arguments)
            );
          }
        ...
        var SparklinesReferenceLine = (function(_React$Component) {
          ...
          function SparklinesReferenceLine() {
            ...
            return _possibleConstructorReturn(
              this,
              (
                SparklinesReferenceLine.__proto__ ||
                Object.getPrototypeOf(SparklinesReferenceLine)
              ).apply(this, arguments)
            );
          }
          ...
          _createClass(SparklinesReferenceLine, [
            {
              ...
              value: function render() {
                ...
                var y =
                  type == 'custom' ? value : dataProcessing[type](ypoints);
        ...
        var SparklinesNormalBand = (function(_React$Component) {
          ...
          function SparklinesNormalBand() {
            ...
            return _possibleConstructorReturn(
              this,
              (
                SparklinesNormalBand.__proto__ ||
                Object.getPrototypeOf(SparklinesNormalBand)
              ).apply(this, arguments)
            );
          }
        ...
        exports.default = function(type, data, upLimit, downLimit, limit) {
          ...
          var max =
            arguments.length > 8 && arguments[8] !== undefined
              ? arguments[8]
              : (0, _max2.default)(data.concat(upLimit, downLimit));
          var min =
            arguments.length > 9 && arguments[9] !== undefined
              ? arguments[9]
              : (0, _min2.default)(data.concat(upLimit, downLimit));
          ...
          var hfactor =
            (width - margin * 2) / ((limit || len) - (len > 1 ? 1 : 0));
