...
const headerSwitch = ({mode, onModeChange, isCanShowFresh, isCanShowHistory, ribbonData}) => {
    ...
    const ribbon = mode === 'history' ?   <Ribbon value={ribbonData.value} msgCode={ribbonData.msgCode}/> : null
