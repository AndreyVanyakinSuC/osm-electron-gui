...
exports.SparklinesArea = exports.SparklinesText = exports.SparklinesNormalBand = exports.SparklinesReferenceLine = exports.SparklinesSpots = exports.SparklinesBars = exports.SparklinesCurveDown = exports.SparklinesCurveUp = exports.SparklinesCurve = exports.SparklinesLine = exports.Sparklines = undefined;
...
var _SparklinesArea = __webpack_require__(15);

var _SparklinesArea2 = _interopRequireDefault(_SparklinesArea);
...
var _SparklinesCurveUp = __webpack_require__(19);

var _SparklinesCurveUp2 = _interopRequireDefault(_SparklinesCurveUp);

var _SparklinesCurveDown = __webpack_require__(20);

var _SparklinesCurveDown2 = _interopRequireDefault(_SparklinesCurveDown);
    ...
    _createClass(Sparklines, [{
        ...
        value: function render() {
            var _props = this.props,
                data = _props.data,
                upLimit = _props.upLimit,
                downLimit = _props.downLimit,
                limit = _props.limit,
                width = _props.width,
            ...
            var points = (0, _dataToPoints2.default)('main', data, upLimit, downLimit, limit, width, height, margin, max, min);
            var up = (0, _dataToPoints2.default)("up", data, upLimit, downLimit, limit, width, height, margin, max, min);
            var down = (0, _dataToPoints2.default)("down", data, upLimit, downLimit, limit, width, height, margin, max, min);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.Children.map(this.props.children, function (child) {
                    return _react2.default.cloneElement(child, { data: data, points: points, up: up, down: down, width: width, height: height, margin: margin });
                })
            );
        }
    }]);
...
Sparklines.propTypes = {
    ...
    upLimit: _propTypes2.default.array,
    downLimit: _propTypes2.default.array,
...
exports.SparklinesCurveUp = _SparklinesCurveUp2.default;
exports.SparklinesCurveDown = _SparklinesCurveDown2.default;
...
exports.SparklinesArea = _SparklinesArea2.default;
...
var SparklinesArea = function (_React$Component) {
    _inherits(SparklinesArea, _React$Component);

    function SparklinesArea() {
        _classCallCheck(this, SparklinesArea);

        return _possibleConstructorReturn(this, (SparklinesArea.__proto__ || Object.getPrototypeOf(SparklinesArea)).apply(this, arguments));
    }

    _createClass(SparklinesArea, [{
        key: 'render',
        value: function render() {
            var _props = this.props,
            ...
            var upCurve = this.props.up.map(function (p) {
                return curve(p);
            }).reduce(function (a, b) {
                return a.concat(b);
            });

            var downCurve = this.props.down.reverse().map(function (p) {
                return curve(p);
            }).reduce(function (a, b) {
                return a.concat(b);
            });

            var fillPoints = upCurve.concat(downCurve);
            ...
            return _react2.default.createElement(
                'g',
                null,
                _react2.default.createElement('path', { d: "M" + upCurve.join(' '), style: lineStyle }),
                _react2.default.createElement('path', { d: "M" + downCurve.join(' '), style: lineStyle }),
                _react2.default.createElement('polygon', { points: fillPoints.join(' '), style: fillStyle })
            );
        }
    }]);

    return SparklinesArea;
}(_react2.default.Component);

SparklinesArea.propTypes = {
    color: _propTypes2.default.string,
    style: _propTypes2.default.object
};
SparklinesArea.defaultProps = {
    type: "main",
    style: {}
};
exports.default = SparklinesArea;
...
var SparklinesCurveUp = function (_React$Component) {
    _inherits(SparklinesCurveUp, _React$Component);

    function SparklinesCurveUp() {
        _classCallCheck(this, SparklinesCurveUp);

        return _possibleConstructorReturn(this, (SparklinesCurveUp.__proto__ || Object.getPrototypeOf(SparklinesCurveUp)).apply(this, arguments));
    }

    _createClass(SparklinesCurveUp, [{
        key: 'render',
        value: function render() {
            var _props = this.props,
                width = _props.width,
            ...
            var linePoints = this.props.up.map(function (p) {
                return curve(p);
            }).reduce(function (a, b) {
                return a.concat(b);
            });
            var closePolyPoints = ["L" + this.props.up[this.props.up.length - 1].x, height - margin, margin, height - margin, margin, this.props.up[0].y];
            var fillPoints = linePoints.concat(closePolyPoints);
    ...
    return SparklinesCurveUp;
}(_react2.default.Component);

SparklinesCurveUp.propTypes = {
    color: _propTypes2.default.string,
    style: _propTypes2.default.object
};
SparklinesCurveUp.defaultProps = {
    type: "main",
    style: {}
};
exports.default = SparklinesCurveUp;
...
var SparklinesCurveDown = function (_React$Component) {
    _inherits(SparklinesCurveDown, _React$Component);

    function SparklinesCurveDown() {
        _classCallCheck(this, SparklinesCurveDown);

        return _possibleConstructorReturn(this, (SparklinesCurveDown.__proto__ || Object.getPrototypeOf(SparklinesCurveDown)).apply(this, arguments));
    }

    _createClass(SparklinesCurveDown, [{
        key: 'render',
        value: function render() {
            var _props = this.props,
                width = _props.width,
            ...
            var linePoints = this.props.down.map(function (p) {
                return curve(p);
            }).reduce(function (a, b) {
                return a.concat(b);
            });
            var closePolyPoints = ["L" + this.props.down[this.props.down.length - 1].x, height - margin, margin, height - margin, margin, this.props.down[0].y];
            var fillPoints = linePoints.concat(closePolyPoints);
    ...
    return SparklinesCurveDown;
}(_react2.default.Component);

SparklinesCurveDown.propTypes = {
    color: _propTypes2.default.string,
    style: _propTypes2.default.object
};
SparklinesCurveDown.defaultProps = {
    type: "main",
    style: {}
};
exports.default = SparklinesCurveDown;
...
exports.default = function (type, data, upLimit, downLimit, limit) {
    ...
    var margin = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : 0;
    var max = arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : (0, _max2.default)(data.concat(upLimit, downLimit));
    var min = arguments.length > 9 && arguments[9] !== undefined ? arguments[9] : (0, _min2.default)(data.concat(upLimit, downLimit));
    ...
    return target.map(function (d, i) {
        return {
            x: i * hfactor + margin,
